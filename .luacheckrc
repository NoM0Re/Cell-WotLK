...
ignore = {
	...
	"11./CELL_.*", -- Setting/accessing a public Cell snippet variable
	...
	"214", -- unused hint
	"221/focusCastMsg", -- Flavor-specific value is only assigned on supported clients
	"221/isImport", -- Shared upstream import/export state
	-- "231", -- Set but never accessed
	"231/absorbEnabled", -- Preserved upstream callback signature
	"231/anchorPoint", -- Preserved upstream layout return value
	"231/blockedFormat", -- Preserved upstream death-report formatting
	"231/criticalText", -- Preserved upstream death-report formatting
	"231/last", -- Preserved upstream click-casting state
	"231/missingBuffsFilters", -- Preserved upstream filter table
	"231/notInterruptible", -- Preserved combat-log payload value
	"231/playerAnchorPoint", -- Preserved upstream layout return value
	"231/point", -- Preserved upstream layout return value
	"231/resistedFormat", -- Preserved upstream death-report formatting
	"231/symbol_1K", -- Locale-specific number symbol
	"231/absorbedFormat", -- Preserved upstream death-report formatting
	"241/classColor", -- Preserved upstream indicator setting state
	"311", -- Value assigned to a local variable is unused
	"312/layout", -- Shared callback signature across frame types
	"314", -- Value of a field in a table literal is unused
	"411/errorMessage", -- Reused in separate decode stages
	"411/items", -- Reused in separate widget branches
	"411/LoadExpansion", -- Expansion-specific loader replacement
	"411/UnitIsPlayer", -- Wrath compatibility localization
...
globals = {
	...
	"CellSpellTooltip",
	"CellTooltip",
	"CellUnitButton_OnLoad",
	"Cell_ExpansionData",
	"Cell_ExpansionDataOverrides",
	"RaidDebuffsTab_Bosses",
	"RaidDebuffsTab_DebuffDetails",
	"RaidDebuffsTab_Instances",
